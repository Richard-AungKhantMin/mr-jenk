...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            ...
            System.out.println("[DataInitializer] Current product count: " + count);
            
            if (count == 0) {
                System.out.println("[DataInitializer] Initializing sample products...");
                ...
                product1.setUserId("sample-seller-1");
                ...
                java.util.List<Product> saved = productRepository.saveAll(products);
                System.out.println("[DataInitializer] Successfully saved " + saved.size() + " products to MongoDB");
            } else {
                System.out.println("[DataInitializer] Products already exist (" + count + "), skipping initialization.");
            }
        } catch (Exception e) {
